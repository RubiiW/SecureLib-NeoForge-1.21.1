...
import net.rubii.securelib.item.custom.*;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> TRICARD = ITEMS.register("tricard", () -> new TricardItem(new Item.Properties()
            .stacksTo(1)));
    ...
    public static final DeferredItem<Item> TRIREADER_EDITOR = ITEMS.register("trireader_editor", () -> new TriEditorItem(new Item.Properties()
            .stacksTo(1)));
